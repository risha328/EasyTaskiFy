...
export const ManagerTasks = () => {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      console.error('Failed to load manager tasks:', err.message);
    } finally {
      setIsLoading(false);
    }
  };
                  ...
                  <div className="space-y-3">
                    {colTasks.length === 0 ? (
                      ...
                      colTasks.map((task) => (
                        <div
                          key={task._id}
                          className="p-4 rounded-xl bg-white border border-zinc-200 shadow-xs hover:border-zinc-400 transition-all space-y-3"
                        >
          ...
          <div className="bg-white border border-zinc-200 rounded-2xl p-6 w-full max-w-md shadow-2xl space-y-4 relative">
            <div className="flex items-center justify-between border-b border-zinc-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-zinc-900">Create Task</h3>
              </div>
            ...
            <form onSubmit={handleCreateTask} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-zinc-800">Status</label>
                  <select
                    value={taskStatus}
