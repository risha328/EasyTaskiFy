    ...
    <div className="space-y-8 max-w-7xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        {organizations.length === 0 ? (
          <div className="p-12 text-center border-2 border-dashed border-zinc-200 rounded-2xl bg-zinc-50 space-y-3">
            ...
            <p className="text-xs text-zinc-500 max-w-sm mx-auto">
              {canCreateWorkspace
                ...
                : 'Contact your Superadmin to assign you to a workspace.'}
            </p>
            {canCreateWorkspace && (
              <button
                onClick={() => setIsModalOpen(true)}
                className="mt-2 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-zinc-900 text-white text-xs font-semibold hover:bg-zinc-800 transition-all"
              >
                <Plus className="w-4 h-4" />
                ...
                <div
                  ...
                  className={`p-6 rounded-2xl border transition-all space-y-4 relative flex flex-col justify-between ${
                    isActive
                      ...
                      : 'bg-white text-zinc-900 border-zinc-200 hover:border-zinc-400 shadow-sm'
                  }`}
                >
                  <div className="space-y-3">
                    ...
                    {org.assignedAdminEmail && (
                      <div
                        className={`flex items-center gap-2 text-xs p-2.5 rounded-lg font-mono ${
                          isActive ? 'bg-white/10 text-zinc-200' : 'bg-zinc-50 text-zinc-700 border border-zinc-200'
                        }`}
                      >
                  ...
                  <div className="pt-2">
                    {isActive ? (
                      <button
                        disabled
                        className="w-full py-2 rounded-xl bg-white/20 text-white text-xs font-semibold flex items-center justify-center gap-2 cursor-default"
                      >
                      ...
                      <button
                        ...
                        className="w-full py-2 rounded-xl bg-zinc-900 text-white text-xs font-semibold hover:bg-zinc-800 flex items-center justify-center gap-2 transition-all shadow-sm"
                      >
